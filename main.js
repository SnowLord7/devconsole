	...
	<div class="snowlord-devConsole-container-body">
		...
		<div class="snowlord-devConsole-container-body-sources showing">
			<div class="snowlord-devConsole-container-body-sources-scripts" style="padding-left: 10px;">
				...
				<div class="snowlord-devConsole-container-body-sources-scripts-preview" style="float: right; padding-right: 10px; width: 39%; height: 100%; background-color: #bababa;">
					<iframe class="snowlord-devConsole-container-body-sources-scripts-preview-frame" width="102%" height="71%" frameborder="0" scrolling="yes"></iframe>
				</div>
			</div>
		</div>
...
(function() {
	...
	consoleInput.addEventListener("keydown", function(e) {
		if (e.keyCode == 13 && !e.ctrlKey && !e.altKey && !e.shiftKey && snowlord_variables.loaded) {
			...
			if (val == "clear()" || val == "clear();" || val == "console.clear()" || val == "console.clear();") {
	...
	document.getElementsByClassName("snowlord-devConsole-container-body-sources-scripts-reload")[0].addEventListener("click", function() {
		...
		for (let i = 0; i < document.getElementsByTagName("script").length; i++) {
			if (document.getElementsByTagName("script")[i].src) {
				other.innerHTML += '<li><a onclick=\'document.getElementsByClassName("snowlord-devConsole-container-body-sources-scripts-preview-frame")[0].src = this.href;\' target="_blank" href=' + document.getElementsByTagName("script")[i].src + '>' + document.getElementsByTagName("script")[i].src.split("/").pop() + '</a></li>';
			}
		}
